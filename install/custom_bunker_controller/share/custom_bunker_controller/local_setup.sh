...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_bunker_dev/install/custom_bunker_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/custom_bunker_controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/custom_bunker_controller/environment/path.sh"
