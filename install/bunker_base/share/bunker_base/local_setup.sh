...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_bunker_dev/install/bunker_base"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bunker_base/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bunker_base/environment/path.sh"
